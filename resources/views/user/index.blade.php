...
<body>
    ...
    <div id="main">
        ...
        <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation grey lighten-3" style="margin-top: 0px;">
                @yield('profile-info')
                ...
                <li class="bold active"><a href="{{url('/dashboard/user')}}" class="waves-effect waves-cyan"><i class="mdi-social-group-add"></i> Pengelolaan User</a></li>
